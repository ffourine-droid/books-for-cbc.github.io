...
export const Icons = {
  ...
  Project: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.75c0-.414.336-.75.75-.75h10.5c.414 0 .75.336.75.75v10.5c0 .414-.336.75-.75.75H6.75a.75.75 0 01-.75-.75V6.75z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75h16.5M3.75 20.25h16.5" />
    </svg>
  ),
  Tutor: () => (
...
export const CURRICULUM: Record<number, Topic[]> = {};
